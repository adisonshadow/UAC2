...
export class EADAFChatProvider extends AbstractChatProvider<
  EADAFChatMessage,
  EADAFChatInput,
  SseChunk
> {
...
export function createEADAFChatProvider() {
  return new EADAFChatProvider({
    request: XRequest<EADAFChatInput, SseChunk, EADAFChatMessage>(
