...
VALUES (
    ...
    '销售管理系统 Demo',
    'sales-demo',
    'AIBase_with_example 销售管理系统 Demo Scope，Tool 查询 SQLite 业务库',
    true
)
...
-- SSO 应用 AIBase_with_example（redirect_uri 需在管理台按需调整）
DELETE FROM uac.applications
WHERE code = 'AIBase_with_example'
...
VALUES (
    ...
    'AIBase_with_example Vite 业务系统接入样板'
)
