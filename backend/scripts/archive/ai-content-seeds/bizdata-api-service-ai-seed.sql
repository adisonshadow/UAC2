...
VALUES
    ...
    (
        ...
        '按主实体/Scope 物化记录推断 connectionId 与 targetSchema；写 SQL 须用返回的 targetSchema',
        'client',
    ...
    (
        -- 不可复用 …637（已分配给 bizdata-rename-entity-code）
